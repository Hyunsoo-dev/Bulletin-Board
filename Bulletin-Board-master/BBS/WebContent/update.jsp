			...
			<form method = "post" action = "updateAction.jsp?bbsID=<%= bbsID %>">
				<table class = "table table-striped" style = "text-align: center; border : 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><input type = "text" name = "bbsTitle" placeholder = "<%= bbsDTO.getBbsTitle() %>" maxlength = "50"></td>
						</tr>
						<tr>
							<td><textarea name = "bbsContent" maxlength = "2048" placeholder = "<%= bbsDTO.getBbsContent() %>"></textarea></td>
						</tr>
					</tbody>
				</table>
